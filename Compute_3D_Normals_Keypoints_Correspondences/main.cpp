                  ...
                  pcl::PointCloud<pcl::PointWithScale>::Ptr &keypoints_out)
{
  ...
  pcl::console::print_value ("\tTime sift keypoints: %g ms\n", t_f_d.toc ());
}
...
int main (int argc, char ** argv)
{
  if (argc != 3)
  {
    std::cout << "Usage: ./correspondences_demo <cloud.pcd> <'normals' or 'keypoints' or 'correspondences'>" << std::endl;
    return (-1);
  }
